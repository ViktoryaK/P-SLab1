...
naiveBayes <- setRefClass("naiveBayes",
       ...
       methods = list(
                    ...
                    predict = function(message)
                    {
                      ...
                      mess <- unnest_tokens(mess, "words", "message", token="words")
                      
                      #для кожного слова знайти в табличці відповідні пробабіліті і підставити у формулу
                     ...
                     #for (word in mess$words) {
                      # index <- match(word, env$words)
                       #n_message <- n_message * match(env$n_n)
                  #     neu_message <- neu_message * match(env$ne_ne)
                   #    p_message <- p_message * match(env$p_p)
                    # }
...
#dav = data.frame(words, n_n)
#vector = c(0.34)
#tidy_text$new <- c(1:length(tidy_text[,2]))
